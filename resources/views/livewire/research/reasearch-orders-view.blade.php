                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @endif
                                            <div>{{ isset($submission->submittedByUser->basic_info) ? $submission->submittedByUser->basic_info->F_Name . ' ' . $submission->submittedByUser->basic_info->L_Name : '' }}</div>
...
@if (!empty($Research_Order->submission_info->Four_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->Four_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->Fifth_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->Fifth_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->Sixth_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->Sixth_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->Seven_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->Seven_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->Eight_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->Eight_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->nine_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->nine_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->ten_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->ten_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->eleven_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->eleven_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->twelve_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->twelve_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->thirteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->thirteen_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->fourteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->fourteen_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Research_Order->submission_info->fifteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->fifteen_DeadLine }}</span>
        </td>
    </tr>
@endif
                            ...
                            <tr>
                                ...
                                <td>:</td>
                                <td>
                                    <span class="font-weight-semibold text-danger">{{ $Research_Order->submission_info->DeadLine_Time }}</span>
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <form action="{{ route('Research.Order.Revision') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-label" class="form-label text-danger">The text area for the revision description must be filled otherwise, it will throw an error.</label>
                                <textarea id="summernote" class="form-control mb-4 is-invalid state-invalid" name="Order_Revision" placeholder="Textarea (invalid state)" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine</label>
            ...
            <div class="btn-list">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#AssignModal">Assign Order</a>
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#NewTaskModal">New Task</a>
                        <a class="dropdown-item" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#RemoveCodinator">Remove Codinator</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table text-center table-vcenter text-nowrap table-bordered border-bottom" id="files-tables">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $loop->iteration}}</td>
                                        <td>{{ isset($revision->revision_by->basic_info) ? $revision->revision_by->basic_info->F_Name . ' ' . $revision->revision_by->basic_info->L_Name : '' }}</td>
                                        <td>{{$revision->created_at}}</td>
                                        <td>
                                            <div class="btn-list">
                                                <div class="dropdown">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <form action="{{ route('Task.Revision') }}" method="POST" class="needs-validation was-validated" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary btn-block add-btn-loader">Send Revision</button>
                </div>
            </form>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="form-label" class="form-label text-danger">The text area for the revision description must be filled otherwise, it will throw an error.</label>
                                <textarea id="summernote2" class="form-control mb-4 is-invalid state-invalid" name="Order_Revision" placeholder="Textarea (invalid state)" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">DeadLine</label>
...
<div class="modal fade" id="RemoveCodinator">
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
              <form action="{{route('Remove.Cordinator')}}" method="POST" class="needs-validation was-validated">
                  @csrf
                  <div class="modal-header">
                                  ...
                                  <select name="assign_id" id="assign-id" class="form-control select2"
                                      ...
                                      @forelse($Research_Order->assign as $assign)
                                          <option value="{{ $assign->basic_info->user_id }}">
                                              {{ $assign->basic_info->F_Name }} {{$assign->basic_info->L_Name}}</option>
                                      @empty
