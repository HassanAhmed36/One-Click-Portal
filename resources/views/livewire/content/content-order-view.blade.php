...
@if ((int) $auth_user->Role_ID === 9 || (int) $auth_user->Role_ID === 10)
    ...
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->F_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->S_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->S_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->T_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->T_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->Four_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->Four_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->Fifth_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->Fifth_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->Sixth_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->Sixth_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->Seven_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->Seven_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->Eight_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->Eight_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->nine_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->nine_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->ten_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->ten_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->eleven_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->eleven_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->twelve_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->twelve_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->thirteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->thirteen_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->fourteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->fourteen_DeadLine }}</span>
        </td>
    </tr>
@endif
...
@if (!empty($Content_Order->submission_info->fifteen_DeadLine))
    <tr>
        ...
        <td>:</td>
        <td>
            <span class="font-weight-semibold text-danger">{{ $Content_Order->submission_info->fifteen_DeadLine }}</span>
        </td>
    </tr>
@endif
