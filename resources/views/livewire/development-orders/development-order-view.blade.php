                ...
                <div class="table-responsive">
                    <table class="table">
                        <tbody>
                            ...
                            @if (!empty($DevelopmentOrder->development_info->order_status))
                                @php

                                    $status = '';
                                    if ($DevelopmentOrder->development_info->order_status == 0) {
                                        $status = 'Working';
                                    } elseif ($DevelopmentOrder->development_info->order_status == 1) {
                                        $status = 'Canceled';
                                    } elseif ($DevelopmentOrder->development_info->order_status == 2) {
                                        $status = 'Completed';
                                    } elseif ($DevelopmentOrder->development_info->order_status == 3) {
                                        $status = 'Revision';
                                    }
                                @endphp
                                <tr>
